...
function resolveConfigPath(key: string): string | null {
  const direct: Record<string, string> = {
    ...
    "breakEvenTriggerPips": "exit.breakEvenTriggerPips",
    ...
    "timeBasedExitEnabled": "exit.timeBasedExitEnabled",
    "timeExitHours": "exit.timeExitHours",
    "structureInvalidationEnabled": "exit.structureInvalidationEnabled",
    "closeOnReverse": "entry.closeOnReverse",
    // Entry refinement
    "limitOrderEnabled": "entry.limitOrderEnabled",
    "limitOrderExpiryMinutes": "entry.limitOrderExpiryMinutes",
    "cooldownMinutes": "entry.cooldownMinutes",
    "scanIntervalMinutes": "entry.scanIntervalMinutes",
    // Protection
    "circuitBreakerPct": "protection.circuitBreakerPct",
    "maxDailyLoss": "protection.maxDailyLoss",
    // Risk (advanced)
    "maxDrawdown": "risk.maxDrawdown",
    "positionSizingMethod": "risk.positionSizingMethod",
    "allowSameDirectionStacking": "risk.allowSameDirectionStacking",
    "conflictBlockAt": "risk.conflictBlockAt",
    "conflictThresholdRaise": "risk.conflictThresholdRaise",
    "atrVolatilityMultiplier": "risk.atrVolatilityMultiplier",
    // Instruments (advanced)
    "correlationFilterEnabled": "instruments.correlationFilterEnabled",
    "maxCorrelatedPositions": "instruments.maxCorrelatedPositions",
    // Strategy
    "structureLookback": "strategy.structureLookback",
    "regimeScoringEnabled": "strategy.regimeScoringEnabled",
    "regimeScoringStrength": "strategy.regimeScoringStrength",
    "htfBiasHardVeto": "strategy.htfBiasHardVeto",
    "requireHTFBias": "strategy.requireHTFBias",
    "normalizedScoring": "strategy.normalizedScoring",
    "onlyBuyInDiscount": "strategy.onlyBuyInDiscount",
    "onlySellInPremium": "strategy.onlySellInPremium",
    "useOrderBlocks": "strategy.useOrderBlocks",
    "useFVG": "strategy.useFVG",
    "useBreakerBlocks": "strategy.useBreakerBlocks",
    "useLiquiditySweep": "strategy.useLiquiditySweep",
    "useDisplacement": "strategy.useDisplacement",
    "useSMT": "strategy.useSMT",
    "useVolumeProfile": "strategy.useVolumeProfile",
    "useAMD": "strategy.useAMD",
    "useDailyBias": "strategy.useDailyBias",
    "useSilverBullet": "strategy.useSilverBullet",
    "useMacroWindows": "strategy.useMacroWindows",
    "useUnicornModel": "strategy.useUnicornModel",
    "useStructureBreak": "strategy.useStructureBreak",
    "structuralConvictionEnabled": "strategy.structuralConvictionEnabled",
  };
