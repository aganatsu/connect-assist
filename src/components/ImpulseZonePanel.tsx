  ...
  return (
    <div className={`rounded border ${borderColor} ${bgColor} px-2 py-1.5 space-y-1.5`}>
      ...
      <div className="flex items-center gap-2">
        <p className={`text-[8px] uppercase tracking-wider font-bold ${titleColor}`}>
          Impulse Zone
        </p>
        {/* TF badges */}
      ...
      {hasZone && bestZone && (
        <>
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <span className="text-[8px] font-mono text-amber-300 px-1 py-0.5 rounded bg-amber-500/10">
      ...
      {scoringEnabled && (
        <div className="flex items-center gap-1">
          <span className="text-[7px] text-muted-foreground">Scoring:</span>
