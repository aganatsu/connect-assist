              ...
              <Tabs value={configTab} onValueChange={setConfigTab}>
                ...
                <TabsContent value="workflow" className="mt-3 space-y-4">
                  ...
                  <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <SelectField label="Premium / Discount" value={config.strategy?.dealingRangeMode ?? "avoid_wrong_side"} options={[{ value: "off", label: "Off" }, { value: "avoid_wrong_side", label: "Block Wrong-Side Entries" }, { value: "strict_value", label: "Require Discount Longs / Premium Shorts" }]} onChange={v => updateConfig("strategy", "dealingRangeMode", v)} />
