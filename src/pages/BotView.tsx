...
export default function BotView() {
  ...
  const { data: status } = useQuery({
    ...
    // Shared key with StatusBar, MobileTopBar and BrokerTradesTab; React Query
    // refetches at the SHORTEST observer interval, so 5s here set the rate for
    // the whole app and each poll costs one TwelveData credit per open symbol.
    // Matched to the others at 10s.
