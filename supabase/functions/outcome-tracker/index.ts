        ...
        try {
          ...
          const { error: updateErr } = await supabase
            ...
            .update({
              ...
              // Persisted so a both-hit setup can be told apart from a clean
              // win after the fact. Without it, 130 of 161 "would_have_won"
              // rows were indistinguishable from the 31 real ones.
