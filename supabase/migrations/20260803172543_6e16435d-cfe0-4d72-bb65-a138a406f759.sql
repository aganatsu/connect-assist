...
GRANT SELECT ON public.streamlined_decision_certificates TO authenticated;
GRANT ALL ON public.streamlined_decision_certificates TO service_role;
ALTER TABLE public.streamlined_decision_certificates ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Users read own streamlined certificates" ON public.streamlined_decision_certificates;
CREATE POLICY "Users read own streamlined certificates"
  ON public.streamlined_decision_certificates FOR SELECT TO authenticated
